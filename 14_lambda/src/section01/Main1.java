...
public class Main1 {
	public static void main(String[] args) {
		...
		/*3. 람다식 이용
		 * ()->{}*/
		/* Calculator 인터페이스 == 함수형 인터페이스 ->추상 메서드 1개만 존재
		 *  ->추상 메서드 int sumTwoNumber(int a, int b)를 오버라이딩*/
		Calculator calc3 =(a,b) ->{ return a+b; };
		//->람다식은 컴파일 시 익명 내부 클래스로 변환된다
		System.out.println("calc3.sumTwoNumber(100, 567) :"+calc3.sumTwoNumber(100, 567));
		
		Calculator calc4 =(a,b) -> 2*(a+b);	//내부 코드가 한 줄 -> {},return 생략가능
