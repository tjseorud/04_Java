...
public class ConsumerTest {
	public static void main(String[] args) {
		 ...
		 * -예전에는 Date, Calendar 등을 이용했지만 deprecated 되어
		 *  최근에는 LocalDate를 사용함
		 *  
		 *LocalDate.now() :현재 시간을 저장한 LocalDate 객체 반환
		 *LocalDate.plusDays(long l) :저장된 시간에서  ㅣ일 후 반환
		 **/
	}
}
